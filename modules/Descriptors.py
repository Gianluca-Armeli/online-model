...
#import modules.rdMolDescriptors as rdMolDescriptors
import modules.rdPartialCharges
import modules.rdMolDescriptors as rdMolDescriptors
import modules.DescriptorUtilities as _du
#from EState import (MaxEStateIndex, MinEStateIndex, MaxAbsEStateIndex,
#                                      MinAbsEStateIndex)
#from QED import qed
...
ExactMolWt = lambda *x, **y: rdMolDescriptors.CalcExactMolWt(*x, **y)
ExactMolWt.version = rdMolDescriptors._CalcExactMolWt_version
...
def FpDensityMorgan1(x):
  return _FingerprintDensity(x, rdMolDescriptors.GetMorganFingerprint, 1)


def FpDensityMorgan2(x):
  return _FingerprintDensity(x, rdMolDescriptors.GetMorganFingerprint, 2)


def FpDensityMorgan3(x):
  return _FingerprintDensity(x, rdMolDescriptors.GetMorganFingerprint, 3)
...
if hasattr(rdMolDescriptors, 'BCUT2D'):
  ...
  _du.VectorDescriptorWrapper(rdMolDescriptors.BCUT2D, names=names, version="1.0.0",
                              namespace=locals())
...
if hasattr(rdMolDescriptors, 'CalcAUTOCORR2D'):
  ...
  autocorr = _du.VectorDescriptorWrapper(rdMolDescriptors.CalcAUTOCORR2D, names=names,
